...
<head>
  ...
  <title>Edit Patient Portal</title>
...
<div class="container-fluid">
  <div class="container-fluid"  style="height: 2rem;">
    <p class="text-dark font-weight-bold"><h3>Edit Patient Details</h3></p>
  </div>
  <center>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="" name="name" value="<?php echo $row['name'] ?>" >
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="" name="ph_no" value="<?php echo $row['ph_no'] ?>">
  ...
  <a href="adminpatview.php" class="font-weight-bold">View Patient Details</a>
</form>
